...
export default function SkillsManagementDosen() {
    ...
    const handleDelete = (id: number) => {
        setDeleting(true);
        router.delete(`/dashboard/dosen/skills/${id}`, {
            onSuccess: () => {
    ...
    const handleSubmit = (data: Skill) => {
        if (data.id) {
            router.put(`/dashboard/dosen/skills/${data.id}`, data, {
                onSuccess: () => {
            ...
            router.post("/dashboard/dosen/skills", data, {
                onSuccess: () => {
    ...
    return (
        <DosenLayout title="Manajemen Ketrampilan">
