...
import { UserDeleteProps } from "@/types/userDelete";
  ...
  return (
    <AdminLayout title="Hapus Pengguna">
      <div className="max-w-lg mx-auto mt-20 bg-white rounded-2xl shadow-xl p-8 border border-purple-200">
        <h2 className="text-xl font-bold text-purple-700 mb-4">Konfirmasi Hapus Pengguna</h2>
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button className="bg-red-600 hover:bg-red-700" onClick={() => handleDeleteUser(user.id!)}>Hapus</Button>
        </div>
      </div>
    </AdminLayout>
  );
