...
export default function CategoriesManagementMahasiswa() {
    ...
    const handleDelete = (id: number) => {
        setDeleting(true);
        router.delete(`/dashboard/mahasiswa/categories/${id}`, {
            onSuccess: () => {
    ...
    const handleSubmit = (data: Category) => {
        if (data.id) {
            router.put(`/dashboard/mahasiswa/categories/${data.id}`, data, {
                onSuccess: () => {
            ...
            router.post("/dashboard/mahasiswa/categories", data, {
                onSuccess: () => {
    ...
    return (
        <MahasiswaLayout title="Manajemen Kategori">
