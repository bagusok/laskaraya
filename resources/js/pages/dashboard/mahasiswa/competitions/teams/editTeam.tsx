...
export default function EditTeam({
    ...
    const [teamMembers, setTeamMembers] =
        useState<Partial<TeamMember>[]>(members);
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        post(route("mahasiswa.teams.edit.post"), {
            onSuccess: (data) => {
                toast.success(
                    ...
                    <div className="flex items-start gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Halaman ini digunakan untuk mengedit tim yang
                                telah terdaftar pada kompetisi{" "}
                                <strong>{competition.name}</strong>. Pastikan
                                semua informasi tim sudah benar sebelum
