...
export default function PeriodList({ periods, className }: PeriodListProps) {
    ...
    return (
        <div className="admin-card">
            <div className="admin-card-header">Daftar Periode</div>
                    ...
                    <CardHeader className="pb-3">
                        <div className="flex justify-between items-center">
                            ...
                            <Button
                                variant="ghost"
                                size="sm"
                                className="text-sm text-gray-500 hover:text-amber-600 hover:bg-amber-50 transition-colors duration-200"
                            >
                    ...
                    <CardContent className="pt-0">
                        <div className="space-y-4">
                            {periods.map((period, index) => (
                                ...
                                >
                                    <div>
                                        <h3 className="font-medium text-gray-900 hover:text-amber-700 transition-colors">
                                            {period.name}
                                        </h3>
                                        <div className="flex items-center mt-1">
                                            <span
                                                className={`w-2 h-2 rounded-full mr-2 ${period.status === "Aktif" ? "bg-green-500" : "bg-amber-500"}`}
                                            ></span>
                                    ...
                                    <span className="text-xs bg-amber-100/30 px-3 py-1 rounded-full text-amber-700 hover:bg-amber-100/50 transition-colors">
                                        {period.events} Acara
                                    </span>
                                </div>
                            ))}
