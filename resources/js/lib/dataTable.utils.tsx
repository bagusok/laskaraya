...
export const handleEdit = (user: User, onEdit?: (user: User) => void, baseRoute: string = 'users') => {
  if (onEdit) {
    onEdit(user);
  } else {
...
export const handleDelete = (user: User, onDelete?: (user: User) => void, baseRoute: string = 'users') => {
  if (onDelete) {
    onDelete(user);
  } else {
